...
const crateNewComponent = async (args) => {
  ...
  const nameListPath = './lib/components';
  ...
  // comand must have 2 args
  if (args.length !== 4) {
    return helpMessage('comand must have 2 args');
  }
